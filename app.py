...
AI tools were used during development for debugging, code generation support,
and iterative refinement of implementation details. The project architecture,
design decisions, and core implementation were developed by the student, with
AI used as an assistance tool.
"""
